Shader "Custom/Laser/LaserWihoutShapeHorizontalCenter"
{
	Properties
	{
		//General properties
		...
		SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				// Animating the hexagons
				//Hex pulse logic
				fixed4 pulseTex = tex.b;
				...
				// Animating the edges of the hexagons.
				//Hex edge pulse logic

				fixed4 hexEdgeTex = tex.b;
				// Animate the edges of the hexagons horizontally from the center.
				fixed4 hexEdgeTerm = hexEdgeTex * _HexEdgeColor * _HexEdgeIntensity *
					max(sin((horizontalDist) * _HexEdgePosScale - _Time.y * _HexEdgeTimeScale) - _HexEdgeWidthModifier, 0.0f) *
					(1 / (1 - _HexEdgeWidthModifier));

				// Animate the edges of the hexagons horizontally. from the outer border.
				//fixed4 hexEdgeTerm = hexEdgeTex * _HexEdgeColor * _HexEdgeIntensity *
				//max(sin((horizontalDist)*_HexEdgePosScale + _Time.y * _HexEdgeTimeScale) - _HexEdgeWidthModifier, 0.0f)*
				//	(1 / (1 - _HexEdgeWidthModifier));

				// Animate the edges of the hexagons vertically from the center
				/*fixed4 hexEdgeTerm = hexEdgeTex * _HexEdgeColor * _HexEdgeIntensity *
					max(sin((verticalDist)*_HexEdgePosScale - _Time.y * _HexEdgeTimeScale) - _HexEdgeWidthModifier, 0.0f) *
					(1 / (1 - _HexEdgeWidthModifier));*/

				// Animate the edges of the hexagons vertically from the outer border.
				/*fixed4 hexEdgeTerm = hexEdgeTex * _HexEdgeColor * _HexEdgeIntensity *
					max(sin((verticalDist) * _HexEdgePosScale + _Time.y * _HexEdgeTimeScale) - _HexEdgeWidthModifier, 0.0f) *
					(1 / (1 - _HexEdgeWidthModifier));*/

				// Animate the edges of the hexagons horizontally and vertically from the center.
				/*fixed4 hexEdgeTerm = hexEdgeTex * _HexEdgeColor * _HexEdgeIntensity *
					max(sin((horizontalDist + verticalDist) * _HexEdgePosScale - _Time.y * _HexEdgeTimeScale) - _HexEdgeWidthModifier, 0.0f) *
					(1 / (1 - _HexEdgeWidthModifier));*/

				// Animate the edges of the hexagons horizontally and vertically from the outer border.
				/*fixed4 hexEdgeTerm = hexEdgeTex * _HexEdgeColor * _HexEdgeIntensity *
					max(sin((horizontalDist + verticalDist) * _HexEdgePosScale + _Time.y * _HexEdgeTimeScale) - _HexEdgeWidthModifier, 0.0f) *
					(1 / (1 - _HexEdgeWidthModifier));*/
